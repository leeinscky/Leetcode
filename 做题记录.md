<!-- vscode-markdown-toc -->
* 1. [商汤科技 | LC-378: 有序矩阵中第K小的元素](#LC-378:K)
* 2. [百度 NLP | LC-240: 搜索mxn矩阵中的一个目标值target](#NLPLC-240:mxntarget)
* 3. [滴滴 | LC-1: 两数之和](#LC-1:)
* 4. [商汤 容器平台 云平台开发工程师 | LC-1: 两数之和](#LC-1:-1)
* 5. [旷视科技 | 1-10000 找出所有质数](#1-10000)
...
##  1. <a name='LC-378:K'></a>商汤科技 | LC-378: 有序矩阵中第K小的元素
有序矩阵 找第k个最小值 （LC-378）
参考答案：
```java
/*
...
##  2. <a name='NLPLC-240:mxntarget'></a>百度 NLP | LC-240: 搜索mxn矩阵中的一个目标值target
...
##  4. <a name='LC-1:-1'></a>商汤 容器平台 云平台开发工程师 | LC-1: 两数之和
...
##  5. <a name='1-10000'></a>旷视科技 | 1-10000 找出所有质数
